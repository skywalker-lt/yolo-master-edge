...
<https://www.gnu.org/licenses/>. The full license terms are
reproduced below.
...
third-party software:
  ...
  * coremltools - Copyright (c) 2020-2023, Apple Inc. All rights
    ...
    promote products derived from this software is not permitted
    without specific prior written permission.

Modifications: This project modifies and extends YOLO-Master with
Core ML export and runtime integration. See the repository commit
history and relevant source files for the details and dates of
modifications.
...
AGPL-3.0, and nothing in it shall be construed as a further
restriction within the meaning of Section 10 of the AGPL-3.0.
